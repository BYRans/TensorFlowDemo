...
trained_lstm_model_preout_model = Model(inputs=trained_lstm_model.input,
                                     outputs=trained_lstm_model.layers[9].output)


lstm_out_X_train = trained_lstm_model_preout_model.predict(X_train)
lstm_out_X_test = trained_lstm_model_preout_model.predict(X_test)

lstm_out_X_train = lstm_out_X_train.reshape(-1,25,25,1)
lstm_out_X_test = lstm_out_X_test.reshape(-1,25,25,1)
